...
/*-----------------------------------------------------------------------------------*/
function niletheme_woo_related_products_limit() {
  global $product;
	
	$args['posts_per_page'] = 6;
	return $args;
}
add_filter( 'woocommerce_output_related_products_args', 'niletheme_related_products_args' );
  function niletheme_related_products_args( $args ) {
...
# Excerpt More
/*-----------------------------------------------------------------------------------*/
function niletheme_excerpt_more( $more ) {
	return '...';
}
add_filter('excerpt_more', 'niletheme_excerpt_more');


function niletheme_custom_excerpt_length( $length ) {
    return 32;
}
add_filter( 'excerpt_length', 'niletheme_custom_excerpt_length', 999 );
 ...
 */
add_filter( 'loop_shop_per_page', 'niletheme_new_loop_shop_per_page', 20 );

function niletheme_new_loop_shop_per_page( $cols ) {
...
function niletheme_social_links() {
    ...
    if ($header_social): foreach ($header_social as $key=>$value) {
        switch($key) {
            ...
            case 'facebook': echo '<li class="list-inline-item facebook"><a href="'.esc_url($niletheme_option['social_facebook_url']).'"><i class="fa-brands fa-facebook"></i></a></li>';
            break;

            case 'twitter': echo '<li class="list-inline-item twitter"><a  href="'.esc_url($niletheme_option['social_twitter_url']).'"><i class="fa-brands fa-twitter"></i></a></li>';
            break;

            case 'google': echo '<li class="list-inline-item google"><a href="'.esc_url($niletheme_option['social_google_url']).'"><i class="fa-brands fa-google"></i></a></li>';
            break;

            case 'linkedin': echo '<li class="list-inline-item linkedin"><a href="'.esc_url($niletheme_option['social_inkedin_url']).'"><i class="fa-brands fa-linkedin-in"></i></i></a></li>';
            break;

            case 'rss': echo '<li class="list-inline-item"><a href="'.esc_url($niletheme_option['social_rss_url']).'"><i class="fa-solid fa-rss"></i></a></li>';
            break;

            case 'instagram': echo '<li class="list-inline-item instagram"><a href="'.esc_url($niletheme_option['social_instagram_url']).'"><i class="fa-brands fa-instagram"></i></a></li>';
            break;

            case 'skype': echo '<li class="list-inline-item"><a href="'.esc_url($niletheme_option['social_skype_url']).'"><i class="fa-brands fa-skype"></i></a></li>';
            break;

            case 'pinterest': echo '<li class="list-inline-item"><a href="'.esc_url($niletheme_option['social_pinterest_url']).'"><i class="fa-brands fa-pinterest"></i></a></li>';
            break;

            case 'vimeo': echo '<li class="list-inline-item"><a  href="'.esc_url($niletheme_option['social_vimeo_url']).'"><i class="fa-brands fa-vimeo"></i></a></li>';
            break;

            case 'youtube': echo '<li class="list-inline-item"><a  href="'.esc_url($niletheme_option['social_youtube_url']).'"><i class="fa-brands fa-youtube"></i></a></li>';
            break;

            case 'whatsapp': echo '<li class="list-inline-item whatsapp"><a  href="'.esc_url($niletheme_option['social_whatsapp_url']).'"><i class="fa-brands fa-whatsapp"></i></a></li>';
            break;

            case 'tumblr': echo '<li class="list-inline-item"><a href="'.esc_url($niletheme_option['social_tumblr_url']).'"><i class="fa-brands fa-tumblr"></i></a></li>';
            break;
 ...
 * Page Title
 */
function niletheme_page_title() {
    global $niletheme_option , $niletheme_meta ; 

     if(function_exists('bcn_display')) { ?>
style="background-image: url(<?php echo esc_url($niletheme_option['page_title_ba']['url']); ?>)"
